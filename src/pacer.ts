...
import { getHostname, debug } from "./utils";
...
let PACER = {
    ...
    parseGoDLSFunction: function (goDLS_string) {
        ...
        if (goDlsDistrict) {
            ...
            res = _.pick(goDlsDistrict, ['hyperlink', 'de_caseid', 'de_seqno', 'got_receipt', 'pdf_header', 'pdf_toggle_possible', 'magic_num', 'hdr']);
            ...
            res = _.pick(goDlsBankr, ['hyperlink', 'de_caseid', 'de_seqno', 'got_receipt', 'pdf_header', 'pdf_toggle_possible', 'magic_num', 'claim_id', 'claim_num', 'claim_doc_seq'])
