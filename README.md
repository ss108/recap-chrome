# NOTES FOR THE MODERNIZED VERSION
...
```
Chrome Headless 84.0.4147.105 (Mac OS 10.15.6) The ContentDelegate class attachRecapLinkToEligibleDocs when there are valid urls attaches a working click handler FAILED
